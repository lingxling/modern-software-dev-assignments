...
const NotesSection = ({
  ...
  return (
    <section className="animate-fade-in">
      <Card className="mb-8">
        <CardHeader title="Notes" badge={`${notes.length} notes`} />
              ...
              editingNote && editingNote.id === note.id ? (
                ...
                >
                  <div className="flex items-start justify-between">
                    <div>
                      <h3 className="font-medium text-secondary-900 dark:text-white mb-1 transition-colors duration-200">
                        {note.title}
                      </h3>
                      <p className="text-secondary-600 dark:text-secondary-400 transition-colors duration-200">
                        {note.content}
                      </p>
                    </div>
